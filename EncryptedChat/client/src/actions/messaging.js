...
export const socket = io.connect('http://localhost:5000/api');
...
export function fetchRecipients() {
    const url = '/chat/user/recipients';
    return dispatch => getData(FETCH_CONVERSATION_USER, CHAT_ERROR, true, url, dispatch);
}
